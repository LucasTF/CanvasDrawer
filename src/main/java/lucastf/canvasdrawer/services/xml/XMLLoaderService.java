package lucastf.canvasdrawer.services.xml;
...
import lucastf.canvasdrawer.shapes.Circle;
import lucastf.canvasdrawer.shapes.Line;
import lucastf.canvasdrawer.shapes.Point;
import lucastf.canvasdrawer.shapes.Polygon;
import lucastf.canvasdrawer.shapes.Rectangle;
...
public class XMLLoaderService {
	...
	public XMLLoaderService(double height, double width) {
		yHeight = height;
		xWidth = width;
	}
	...
	public ArrayList<IDrawing> importXML(){
		...
		try {
			File loadFile = FileManagerService.loadFile("XML");
			if(loadFile != null) {
